...
/* 电缆终端头 */
public class SgCableTerminal extends View implements IObject
{
	public SgCableTerminal(Context context) {  
        super(context); 
	...
	protected void onDraw(Canvas canvas) {
		...
		// 绘制
		Path path = new Path();
		path.moveTo(nWidth/2, nHeight);
		path.lineTo(0, nHeight/5);
		path.lineTo(nWidth, nHeight/5);
		path.lineTo(nWidth/2, nHeight);
		path.lineTo(nWidth/2, 0);
