...
import com.sg.web.SgAlarmChangeTimeObject;
...
/** 标签 */
public class SgAlarmChangTime extends TextView implements IObject ,ViewObjectSetCallBack{
	...
	ViewObjectBase base=new SgAlarmChangeTimeObject();
