...
public class SgIsolationSwitch extends View implements IObject {
	...
	protected void onDraw(Canvas canvas) {
		...
		float nWidth = ((float) (m_nWidth) / (float) MainWindow.FORM_WIDTH)
				* (float) (m_rRenderWindow.VIEW_RIGHT - m_rRenderWindow.VIEW_LEFT);
		float nHeight = ((float) (m_nHeight) / (float) MainWindow.FORM_HEIGHT)
				* (float) (m_rRenderWindow.VIEW_BOTTOM - m_rRenderWindow.VIEW_TOP);
