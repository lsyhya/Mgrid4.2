...
public class SgBrokenLine extends TextView implements IObject {
	...
	private LinkedList<SplineData> chartData = new LinkedList<SplineData>();;// Y轴标签对�?
	...
	String m_strClickEvent = "科士�?-IDU系统设定UPS.xml";
	...
	private List<List<Double>> partList = new ArrayList<List<Double>>(); // �?有线的数据�?�集�?
