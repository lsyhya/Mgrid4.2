...
/** 历史信号 */
//信号历史数据 HistorySignalList 与SaveEquipt 一致
//author :fjw0312
//time:2015 11 23
public class HistorySignalList extends UtTable implements IObject {

	public HistorySignalList(Context context) {
		super(context);
		m_rBBox = new Rect();
		...
		lstTitles.add("  Signal name  ");
		lstTitles.add("      Value    ");
		lstTitles.add("      Unit     ");		
		lstTitles.add("   Value type  ");
...
//		fjw_signal.clear();
	...
	public boolean parse_expression(){
		...
		//			String str_signalName = DataGetter.getSignalName(equipt_id, signal_id);
					...
					map_EquiptNameList.put(str_equiptName, String.valueOf(equipt_id));
	...
	//处理绑定的设备id为0
	public boolean parse_EquipZero(){
