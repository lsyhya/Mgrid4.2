...
public class Dial extends View implements IObject,ViewObjectSetCallBack {
	...
	private ViewObjectBase base=new DialObject();
	private String  fillColor,warmPerColor,lineColor;
