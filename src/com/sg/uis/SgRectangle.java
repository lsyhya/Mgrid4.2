...
/** 方型 */
public class SgRectangle extends View implements IObject, ViewObjectSetCallBack {

	public ViewObjectBase base = new RectangleObject();
	...
	protected void onDraw(Canvas canvas) {
		...
		// Log.e("TAG",
		// m_nWidth+"::"+MainWindow.FORM_WIDTH+":::"+MainWindow.FORM_HEIGHT+"::"+m_rRenderWindow.VIEW_RIGHT+":::"+m_rRenderWindow.VIEW_LEFT+":::"+m_rRenderWindow.VIEW_BOTTOM+"::"+m_rRenderWindow.VIEW_TOP);
